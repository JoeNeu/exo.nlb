...
docker run -d \
  ...
  -v /etc/grafana/provisioning/notifiers/notifiers.yml:/etc/grafana/provisioning/notifiers/notifiers.yml \
  -v /etc/grafana/provisioning/dashboards/dashboards.yml:/etc/grafana/provisioning/dashboards/dashboards.yml \
  -v /etc/grafana/dashboards/dashboard.json:/etc/grafana/dashboards/dashboard.json \
  grafana/grafana
